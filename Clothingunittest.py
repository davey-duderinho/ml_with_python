...
class TestClothingClass(unittest.TestCase):
    def setUp(self):
        self.clothing = Clothingcode.Clothing('orange', 'M', 'stripes', 35)
        self.blouse = Clothingcode.Blouse('blue', 'M', 'luxury', 40, 'Brazil')
        self.pants = Clothingcode.Pants('black', 32, 'baggy', 60, 30)
